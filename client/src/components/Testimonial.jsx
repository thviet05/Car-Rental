...
const Testimonial = () => {
    ...
    const testimonials = [
        { name: "Nguyen Anh Tuan", 
          ...
          testimonial: "Toi da thue xe tu nhieu cong ty khac nhau, nhung trai nghiem voi CarRental thi xuat sac." 
        },
        { name: "Nguyen Danh Khai", 
          location: "Ha Noi, Viet Nam", 
          image: assets.testimonial_image_2, 
          testimonial: "CarRental da giup chuyen di cua toi tro nen de dang hon rat nhieu. Xe duoc giao tan cua, va dich vu khach hang thi tuyet voi!" 
        },
        { name: "Le Dinh Minh", 
